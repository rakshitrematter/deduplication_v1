#!/usr/bin/env python3
"""
jaro-winkler company deduplication (refactored)
uses jaro-winkler similarity for company name matching
"""
...
def main():
    print("=" * 60)
    print("JARO-WINKLER DEDUPLICATION")
    print("=" * 60)
    ...
    print("calculating jaro-winkler similarity matrix...")
    ...
    clustered_file, canonical_file, analysis_file = save_results(
        df_clustered, canonical_df, cluster_stats, output_dir, "jaro_winkler"
    )
    
    print(f"\njaro-winkler deduplication complete!")
