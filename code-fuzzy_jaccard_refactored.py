#!/usr/bin/env python3
"""
fuzzy jaccard company deduplication (refactored)
uses fuzzy jaccard similarity for company name matching
"""
...
def main():
    print("=" * 60)
    print("FUZZY JACCARD DEDUPLICATION")
    print("=" * 60)
    ...
    # calculate fuzzy jaccard similarity matrix
    print("calculating fuzzy jaccard similarity matrix...")
    ...
    clustered_file, canonical_file, analysis_file = save_results(
        df_clustered, canonical_df, cluster_stats, output_dir, "fuzzy_jaccard"
    )
    
    print(f"\nfuzzy jaccard deduplication complete!")
